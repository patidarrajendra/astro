        ...
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <a class="btn btn-primary" href="<?php echo base_url('admin/products')?>"><i class="fa fa-th-list">&nbsp;Add Product </i></a>
                </div>
                <!-- /.panel-heading -->
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered display nowrap" cellspacing="0" width="100%" id="notice">
                        ...
                        <tbody>
                            <?php $count=1; if(!empty($products)) {  foreach ($products as  $value) {?>
                            <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                ...
                                <td class="center">
                                 ...
                                 <td class="center">
                                 <a href="<?php echo base_url('admin/products/'.$value->id); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>

<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Horoscopes List </h1>
        </div>
        <!-- /.col-lg-12 -->
    </div>
    <!-- row -->
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered display nowrap" cellspacing="0" width="100%" id="notice">
                        ...
                        <tbody>
                            <?php $count=1; if(!empty($horoscopes)) {  foreach ($horoscopes as  $value) {?>
                            <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                <td>
                                    <?php echo $count; ?>
                                </td>
                                <td class="center">
                                    <?php echo ucwords($value->horoscope_name); ?>
                                </td>
                                <td class="center">
                                ...
                                <td class="center">
                                    <?php echo $value->brief_desc;  ?>
                                </td>
                                <td class="center">
                                    <?php echo $value->created_at;  ?>
                                </td>
                                 <td class="center">
                                 <a href="<?php echo base_url('admin/horoscopes/'.$value->id); ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
